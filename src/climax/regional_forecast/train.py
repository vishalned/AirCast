...
def main():
    ...
    try:
        ...
        normalization = cli.datamodule.out_normalize
        mean_norm, std_norm = normalization.mean, normalization.std
    mean_denorm, std_denorm = -mean_norm / std_norm, 1 / std_norm
    cli.model.set_denormalization(mean_denorm, std_denorm)
    cli.model.set_out_vars(cli.datamodule.hparams.out_variables)
    ...
    if not cli.model.visualize_pred:
        ...
        # ONLY FOR TESTING
        # cli.trainer.test(cli.model, datamodule=cli.datamodule, ckpt_path="./regional_forecast/experiments/checkpoints/last-v4.ckpt")
        cli.trainer.test(cli.model, datamodule=cli.datamodule, ckpt_path="regional_forecast/exp8/checkpoints/last.ckpt")
